...
define([
  ...
  function(declare, lang, query, html, array, fx, all, Deferred, dom, JSON, on, parser, sniff, _WidgetsInTemplateMixin,
    ...
    esriRequest, esriConfig, SingleTask) {
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      */
	  ...
	  _initUploadBox: function(){
		alert("We are the pirates who don't do anything!");
		...
		//myUploader = new Uploader(...); // disregard reference argument
      ...
      _onBtnApplyClicked:function(){
        ...
        if(this.cbxUseSpatial.checked){
          if(this.cbxUseMapExtent.checked){
			...
			//assign geometry to the geometry of the uploaded shape file
			/*var gs =
			  if(gs.length > 0){				
